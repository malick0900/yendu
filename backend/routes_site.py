...
DEFAULT_SITE_CONTENT = {
    ...
    "testimonials_title": "Ils ont vécu Teranga Stay",
    "testimonials": [
    ...
    "about_title": "L’hospitalité, fil rouge de Teranga Stay.",
    "about_kicker": "Notre histoire",
    "about_text": "Teranga Stay est né d’une conviction : un voyage réussi est un voyage vécu. Notre mission est de connecter les voyageurs aux meilleures adresses du Sénégal — logements premium et expériences immersives — dans une plateforme exigeante sur la qualité et chaleureuse comme une journée à Saly.\n\nChaque hébergement et chaque expérience est sélectionné par notre équipe. Nous ne sommes pas une marketplace ouverte : nous publions, nous validons, nous vous accompagnons. C’est notre garantie d’un séjour sans accroc.\n\nVision : devenir la référence du voyage premium en Afrique de l’Ouest — à commencer par le Sénégal, terre de Teranga.",
    "contact_email": "contact@terangastay.sn",
    "contact_phone": "+221 33 800 00 00",
    "contact_address": "Almadies, Dakar, Sénégal",
    "faqs": [
        {"q": "Comment fonctionne le paiement ?", "a": "Pour le MVP, le paiement est confirmé manuellement par notre équipe Teranga Stay après votre réservation. Nous vous contacterons pour finaliser la transaction."},
        {"q": "Puis-je annuler ma réservation ?", "a": "Oui, tant que la réservation est « en attente », contactez-nous pour l’annuler sans frais."},
        {"q": "Qui sélectionne les hébergements ?", "a": "Tous les hébergements et expériences sont sélectionnés par notre équipe. Teranga Stay n’est pas une marketplace ouverte."},
