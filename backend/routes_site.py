...
DEFAULT_SITE_CONTENT = {
    ...
    "hero_subtitle": "Logements premium et expériences locales, soigneusement sélectionnés pour vous faire ressentir la chaleur du Teranga.",
    ...
    "properties_title": "Logements premium",
